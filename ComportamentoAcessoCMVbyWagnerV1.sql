...
SELECT COUNT(*) AS QTD ,DT_MES_ACESSO AS MES FROM TMP_SQD_AA_BASE_CAD_CMV_01 GROUP BY DT_MES_ACESSO;
--- 5864177 2020/07
...
---------------- SOMENTE VALIDAÇÕES------------------------------------------------------
SELECT -- MIN (DT_ACESSO) AS TESTE -- ADD_MONTHS(DT_REFERENCIA,-4) TESTE2 
