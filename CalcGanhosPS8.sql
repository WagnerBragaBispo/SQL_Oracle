...
SELECT * FROM U92047747.TMP_SQDAA_DIM_FUNC_ATH_URA;
SELECT * FROM U92047747.TMP_SQDAA_DIM_FUNC_CMV;
SELECT * FROM U92047747.TMP_SQDAA_DIM_MOT_ATH_URA;
SELECT * FROM U92047747.TMP_SQDAA_DIM_MOT_CMV;



---===========================================================================================================================
-- objetivo: obter calculo de ganho Projeto Digital
-- cmv

---===========================================================================================================================
SELECT * FROM BI_DIM_METODO_CONTATO;
...
--AND T.DW_METODO_CONTATO IN (781,86)---WhatsApp,WPP
AND T.NUM_NTC = '42988320266'
GROUP BY 
        MC.DW_METODO_CONTATO
